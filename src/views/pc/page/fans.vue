	...
	<div class="fans">
		...
		<el-card class="box-card">
		  <div slot="header" class="clearfix">
		    <span class="label">我的粉丝</span>
		    <span style="float: right; padding: 3px 0; font-size: 14px;">我的粉丝: {{total}}人</span>
		  </div>		  
		  <el-row :gutter="12">
			  <el-col :span="8" v-for="(item, index) in datas" :key="index" style="margin: 10px 0;">
			    <el-card shadow="always" class="item">
			      <div slot="header" class="clearfix">
					    ...
					    <el-button size="mini" @click="follow" class="follow">关注</el-button>
					  </div>
	...
	export default {
		...
		methods: {
      	...
      	this.$api.post('/user/follow', {
			...
			load() {
				var self = this
				self.$api.get('/user/fans', {
					toAccountId: self.currentUser.accountId,
