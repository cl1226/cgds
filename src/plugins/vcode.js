(function(){
    ...
    vCode.prototype.addEvent = function(){
        ...
        if (agent.match('msie')) {
            _this.dom.attachEvent('click', function() {
    ...
    vCode.prototype.drawCode = function(code, index){
        ...
        dom.style.cssText = [
            ...
            // "filter:progid:DXImageTransform.Microsoft.Matrix(M11=" + Math.cos(0)+",M12=" + -Math.sin(0) + ",M21=" + Math.sin(0) + ",M22=" + Math.cos(0) + ",SizingMethod='auto expand')",
    ...
    vCode.prototype.drawLines = function(){
        ...
        for(var i=0; i<this.options.lines; i++){
            ...
            dom.style.cssText = [
                ...
                "-webkit-transform:rotate(" + randint(-30, 30) + "deg)",
                "-o-transform:rotate(" + randint(-30, 30) + "deg)",
                "filter:progid:DXImageTransform.Microsoft.Matrix(M11=" + Math.cos(randint(-30, 30))+",M12=" + -Math.sin(randint(-30, 30)) + ",M21=" + Math.sin(randint(-30, 30)) + ",M22=" + Math.cos(randint(-30, 30)) + ",SizingMethod='auto expand')",
                "font-family:" + this.options.fonts[randint(0, this.options.fonts.length - 1)],
                "font-weight:" + randint(400, 900)
            ].join(";");
            this.dom.appendChild(dom);
